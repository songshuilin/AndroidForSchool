...
import com.example.edu.androidforschool.util.BusLineOverlay;

import java.util.ArrayList;
import java.util.List;

public class FindLoadActivity extends FragmentActivity implements
    ...
    public void searchButtonProcess(View v) {
        ...
        EditText editSearchKey = (EditText) findViewById(R.id.busline);
    ...
    public void onGetBusLineResult(BusLineResult result) {
        if (result == null || result.error != SearchResult.ERRORNO.NO_ERROR) {
            Toast.makeText(FindLoadActivity.this, "抱歉，未找到结果",
        ...
        Toast.makeText(FindLoadActivity.this, result.getBusLineName(),
